...
const ownerNumber = ['237659079843']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("TAKA-MD~", '');
...
console.log("CONNECTING TAKA-MD 🧞...");
...
console.log('TAKA-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *TAKA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴛᴀᴋᴀ ᴛᴇᴄʜ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴛᴀᴋᴀ-ᴍᴅ༆࿇*

*https://whatsapp.com/channel/0029Vark1I1AYlUR1G8YMX31*

> *❁ᴊᴏɪɴ ᴏᴜʀ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴛᴀᴋᴀ-ᴍᴅ❁*

*https://youtube.com/@Diorrebero*

*╭⊱✫🐲 ᴛᴀᴋᴀ-ᴍᴅ 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *TAKA-MD*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *ᛕ꠸ꪀᧁꪻꪖᛕꪖ*
*│✫➠ - 🌐URL:* *https://github.com/Takatech85/TAKA-MD*
...
//================ownerreact==============
if(senderNumber.includes("237690768603")){
if(isReact) return
m.react("👑")
}
