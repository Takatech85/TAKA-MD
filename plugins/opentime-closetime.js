...
if (!isAdmins) return reply(ADMIN)	
  if (args[1] == 'second') {
                ...
                setTimeout(() => {
                    ...
                    const open = `OPEN TIME THE GROUP WAS OPENED BY TAKA-MD TO APPROVED ADMIN\n NOW MEMBERS CAN SEND MESSAGES 🔓`
...
if (!isAdmins) return reply(ADMIN)	
                ...
                setTimeout(() => {
                    ...
                    const close = `CLOSE TIME GROUP CLOSED BY TAKA-MD AT APPROVED ADMIN\nNOW ONLY ADMIN CAN SEND MESSAGES 🔐`
...
if (!isBotAdmins) return reply(mg.needbotadmins);     
           ...
           const mass = await conn.sendMessage(m.chat, { text: '*GROUP CHAT MUTED BY TAKA-MD* 🔒' }, { quoted: mek });
...
if (!isBotAdmins) return reply(mg.needbotadmins);     
           ...
           const mass = await conn.sendMessage(m.chat, { text: '*GROUP CHAT UNMUTED BY TAKA-MD* 🔒' }, { quoted: mek });
            return await conn.sendMessage(m.chat, { react: { text: '🔒', key: mass.key } });
} catch(e) {
console.log(e);
reply('*PLEASE GIVE ME A ADMIN ROLE❗👻*')    
