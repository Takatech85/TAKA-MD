...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/Takatech85/TAKA-MD';

    // Check update status
    let updateMessage = `*✅ 𝖸𝖮𝖴R TAKA-MD 𝖡𝖮T 𝖨𝖲 𝖴𝖯-𝖳𝖮-𝖣𝖠𝖳𝖤!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫YOU ARE NOT ON CURRENT VERSION FOR TAKA-MD BRO *
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: '𝗧𝗔𝗞𝗔 𝗧𝗘𝗖𝗛 𝐕𝐄𝐑𝐒𝐈𝐎𝐍',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
